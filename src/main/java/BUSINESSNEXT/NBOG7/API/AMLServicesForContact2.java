...
public class AMLServicesForContact2 {
//public static String Token;
    // SAAJ - SOAP Client Testing
    //public static void main(String args[]) {

public static void AMLServicesCallCont2() {
        /*
    ...
    private static void createSoapEnvelope(SOAPMessage soapMessage) throws SOAPException {
        ...
        ItemId.addTextNode(LeadObjectPageMethod.contactid2);
        SOAPElement ItemType = SaveRequest.addChildElement("ItemType", myNamespace);
        ItemType.addTextNode("Contact");
